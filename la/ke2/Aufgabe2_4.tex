...
\doublespacing
\noindent\textbf{Aufgabe 2.4} \\
Damit $W_t$ ein Komplement von U ist, muss die direkte Summe $\mathbb{R}^4 = U \oplus W_t$ gelten. \\
Setze
$$A =\begin{pmatrix} 1 & 0 & 1 & 2 \\ 1 & -1 & 2 & 0 \end{pmatrix}, \quad U=\ker(A)$$
Da $A$ Rang 2 hat, gilt:
$$\dim U = 4 - 2= 2$$
Die Dimension von $W_t$ ist offensichtlich 2 für alle $t$.
